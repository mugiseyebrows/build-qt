...
set PATH=C:\Windows\System32;C:\Program Files\7-Zip;C:\Program Files\Git\cmd;C:\mingw1310_64\bin;C:\mysql-8.2.0-winx64\bin;C:\mysql-8.2.0-winx64\lib;C:\postgresql-14\bin;C:\Qt\6.11.0\mingw_64\bin;C:\icu\bin;C:\llvm19\bin;%LOCALAPPDATA%\Programs\Python\Python313;%LOCALAPPDATA%\Programs\Python\Python313\Scripts;C:\Python313;C:\Python313\Scripts;C:\Miniconda3;C:\Miniconda3\Scripts;%USERPROFILE%\Miniconda3;%USERPROFILE%\Miniconda3\Scripts;C:\Windows
...
7z rn qt-everywhere-src-6.11.0.zip qt-everywhere-src-6.11.0 src
if not exist src 7z x -y qt-everywhere-src-6.11.0.zip
:source_end
set LLVM_INSTALL_DIR=C:\llvm19
pushd src
    "%PATCH%" -N -p1 -i ../0001-missin-min-and-max-def.patch
    call configure -prefix C:\Qt\6.11.0\mingw_64 -opensource -confirm-license -shared -platform win32-g++ -opengl desktop -release -submodules qtbase,qtimageformats -nomake tests -nomake examples -- -DFEATURE_system_zlib=OFF -DFEATURE_sql_mysql=ON -DFEATURE_sql_psql=ON -DPostgreSQL_ROOT=C:/postgresql-14 -DMySQL_ROOT=C:/mysql-8.2.0-winx64 -DICU_ROOT=C:/icu
    type config.summary
        cmake --build . || exit /b
popd
set LLVM_INSTALL_DIR=C:\llvm19
...
7z a -y Qt-6.11.0-mingw13.7z C:\Qt\6.11.0\mingw_64
